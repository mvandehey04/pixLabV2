...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
    /*Picture pix = new Picture("catepillar.jpg");
    pix.explore();*/
    
    
    Picture p = new Picture("catepillar.jpg");
    Picture smallP = p.scale(0.25, 0.25);
    smallP.write("smallCatepillar.jpg");
    smallP.explore();
  ...
  /*****************************************************************
   * Code below this point is instrumental for the project to work, 
   * however as an APCS student you are not expected to understand 
   * or modify any parts. If you'd like, consider this code black 
   * box and invisible to you. You are also encouraged to explore 
   * the code may be surprised with how much you understand.
   *****************************************************************/
  // current indices
  /** row index */
